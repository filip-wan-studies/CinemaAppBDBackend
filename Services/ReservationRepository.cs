...
namespace CinemaAppBackend.Services
{
    public class ReservationRepository : IReservationRepository
    {
        ...
        {
            var reservations = _context.Reservations.Include("Client").Where(r => r.Email == email || r.Client.Email == email).Include("Ticket.Screening.Film").Include("Ticket.ScreenSeat.Seat").ToList();
        ...
        public Reservation PostReservation(uint id, uint screeningId, uint screenSeatId)
        {
            ...
            var reservation = new Reservation { ClientId = id, SubmissionDate = DateTime.Now, Ticket = ticket, Client = null };
