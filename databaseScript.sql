...
CREATE TABLE IF NOT EXISTS Employees(id_employee smallint unsigned not null auto_increment, name varchar(40) not null, surname varchar(40) not null, phone_number decimal(11,0), email varchar(50) not null, salary mediumint not null check(salary>0), constraint primary key(id_employee));
